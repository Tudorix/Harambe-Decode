...
public class AutoCloseBlue extends OpMode {
    ...
    private final Pose scorePose = new Pose(54, 53  , Math.toRadians(225)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose scorePose1 = new Pose(54,53,Math.toRadians(270)); // scorePose 1 doar cu turreta
    private final Pose pickup1Pose = new Pose(61, 45, Math.toRadians(270)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup1_3Pose = new Pose(61, 19, Math.toRadians(270)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(83, 45, Math.toRadians(270)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup2_3Pose = new Pose(83,11,Math.toRadians(270));
    private final Pose parkPose = new Pose(40.7, 53, Math.toRadians(240)); // Park // Park
    private final Pose unloadPose = new Pose(83.2,13,Math.toRadians(237.5));
    private final Pose curveAsist = new Pose(79,42,Math.toRadians(270));
    private final Pose rest = new Pose (68,53, Math.toRadians(272));
    double shoots = 0;
