...
@Autonomous(name = "Auto Close Red Updated" , group = "Test")
public class AutoCloseRedUpdated extends OpMode {
    int target=0;
    private final Pose startPose = new Pose(14.8, 118.7, 2.26); // Start Pose of our robot.
        private final Pose scorePose = new Pose(56.1, 88  , Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose scorePose1 = new Pose(56.1,90.5,Math.toRadians(90)); // scorePose 1 doar cu turreta
    private final Pose scorePose2 = new Pose(56.1,90.5,Math.toRadians(90)); // scorePose 1 doar
    private final Pose pickup1Pose = new Pose(61, 99, Math.toRadians(90)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup1_3Pose = new Pose(61, 124, Math.toRadians(90)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(80, 99   , Math.toRadians(90)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup2_3Pose = new Pose(80,130,Math.toRadians(90));
    private final Pose parkPose = new Pose(40.7, 91, 2.116); // Park // Park
    private final Pose unloadPose = new Pose(84.7,132.4,Math.toRadians(123.5));
    private final Pose unloadPose2 = new Pose(84.7  ,132.3,Math.toRadians(123.5));
    private final Pose curveAsist = new Pose(80,110,Math.toRadians(90));
    private final Pose sussyCurva = new Pose(105,105,0);
